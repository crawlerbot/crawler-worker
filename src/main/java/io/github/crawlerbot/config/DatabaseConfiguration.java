...
@Configuration
@EnableElasticsearchRepositories("io.github.crawlerbot.repository.search")
@EnableMongoRepositories(basePackages = "io.github.crawlerbot.repository", includeFilters = @Filter(type = FilterType.ASSIGNABLE_TYPE, value = MongoRepository.class))
...
public class DatabaseConfiguration {
    ...
    public Mongobee mongobee(MongoClient mongoClient, MongoTemplate mongoTemplate, MongoProperties mongoProperties) {
        ...
        mongobee.setChangeLogsScanPackage("io.github.crawlerbot.config.dbmigrations");
